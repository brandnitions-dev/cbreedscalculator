...
export const ESSENTIAL_OILS: Ingredient[] = [
  ...
  { id: 'oud', name: 'Oud (agarwood)', desc: 'Dark resinous luxury note with deep fixative power. Use as a tiny prestige accent because the scent dominates quickly.', benefits: { calming: 3, antiaging: 1, grounding: 3 }, potency: 'strong', tips: { low: 'Trace oud — niche luxury signal without overpowering.', mid: 'Distinct agarwood base; keep florals and vanilla restrained.', high: 'Oud-forward — intense, costly, and polarising.' } },
